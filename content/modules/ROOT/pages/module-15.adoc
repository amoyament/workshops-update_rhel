...
image::exercise-2-8-system-roles/demo-project.png[system roles project]
...
image::exercise-2-8-system-roles/job.png[job template]
...
image::exercise-2-8-system-roles/survey.png[survey]

Click Launch:

image::exercise-2-8-system-roles/launch.png[launch]

If a confirmation step is shown:

image::exercise-2-8-system-roles/next.png[next button]
