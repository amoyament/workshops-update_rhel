...
image::exercise-2-8-system-roles/demo-project.png[system roles project,link=self,window=_blank,width=60%]
...
image::exercise-2-8-system-roles/job.png[job template,link=self,window=_blank,width=60%]
...
image::exercise-2-8-system-roles/survey.png[survey,link=self,window=_blank,width=60%]

Click Launch:

image::exercise-2-8-system-roles/launch.png[launch,link=self,window=_blank,width=60%]

If a confirmation step is shown:

image::exercise-2-8-system-roles/next.png[next button,link=self,window=_blank,width=60%]
