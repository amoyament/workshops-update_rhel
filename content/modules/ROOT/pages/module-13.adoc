...
image::exercise-2-6-workflows/create_project.png[create_project,link=self,window=_blank,width=60%]
...
image::exercise-2-6-workflows/create_template_webops.png[create_template_webops,link=self,window=_blank,width=60%]
...
image::exercise-2-6-workflows/visualizer_add_step.png[add_step,link=self,window=_blank,width=60%]
...
image::exercise-2-6-workflows/visualizer_add_step_app_deploy.png[app_deploy,link=self,window=_blank,width=60%]

image::exercise-2-6-workflows/visualizer_add_step_add_link.png[add_link,link=self,window=_blank,width=60%]

image::exercise-2-6-workflows/visualizer_add_step_nodejs.png[add_nodejs,link=self,window=_blank,width=60%]

Click *Save* to finalize the workflow.

image::exercise-2-6-workflows/visualizer_overview.png[overview,link=self,window=_blank,width=60%]

=== Launch workflow

From the *Deploy Webapp Server* template, select *Launch template* from the kebab menu (⋮) or from the template detail page.

image::exercise-2-6-workflows/launch_template.png[launch_template,link=self,window=_blank,width=60%]
