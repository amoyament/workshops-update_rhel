...
image::exercise-2-6-workflows/create_project.png[create_project]
...
image::exercise-2-6-workflows/create_template_webops.png[create_template_webops]
...
image::exercise-2-6-workflows/visualizer_add_step.png[add_step]
...
image::exercise-2-6-workflows/visualizer_add_step_app_deploy.png[app_deploy]

image::exercise-2-6-workflows/visualizer_add_step_add_link.png[add_link]

image::exercise-2-6-workflows/visualizer_add_step_nodejs.png[add_nodejs]

Click *Save* to finalize the workflow.

image::exercise-2-6-workflows/visualizer_overview.png[overview]

=== Launch workflow

From the *Deploy Webapp Server* template, select *Launch template* from the kebab menu (⋮) or from the template detail page.

image::exercise-2-6-workflows/launch_template.png[launch_template]
