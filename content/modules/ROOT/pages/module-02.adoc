...
image::exercise-1-2-variables/system_setup_output.png[system_setup.yml output,link=self,window=_blank,width=60%]
...
image::exercise-1-2-variables/system_checks_output.png[system_checks.yml output,link=self,window=_blank,width=60%]
