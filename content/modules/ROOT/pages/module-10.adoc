...
link:https://github.com/ansible/workshop-examples[workshop-examples,window=_blank]
...
image::exercise-2-3-projects/create_project.png[Create project,link=self,window=_blank,width=60%]
...
image::exercise-2-3-projects/project_sync.png[Project Sync,link=self,window=_blank,width=60%]
...
image::exercise-2-3-projects/create_job_template.png[Create job template,link=self,window=_blank,width=60%]
...
image::exercise-2-3-projects/template_detail.png[template details,link=self,window=_blank,width=60%]

Job Run

image::exercise-2-3-projects/job_run.png[job_run,link=self,window=_blank,width=60%]
...
image::exercise-2-3-projects/jobs_view.png[Jobs view,link=self,window=_blank,width=60%]
