...
TASK [Create a new user] *******************************************************
changed: [node03] => (item=alice)
changed: [node01] => (item=alice)
changed: [node02] => (item=alice)
changed: [control] => (item=alice)
changed: [node03] => (item=bob)
changed: [node01] => (item=bob)
changed: [node02] => (item=bob)
changed: [node03] => (item=carol)
changed: [control] => (item=bob)
changed: [node01] => (item=carol)
changed: [node02] => (item=carol)
