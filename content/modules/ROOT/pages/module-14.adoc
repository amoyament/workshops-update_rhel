...
This exercise uses the same *Workshop Project* created in a previous exercise. In the Ansible Automation Controller UI, navigate to *Automation Execution → Projects* and confirm that *Workshop Project* has synced successfully before continuing.
