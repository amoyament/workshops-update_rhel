...
* linux/hardening.yml
** link:https://github.com/ansible-tmm/RHEL-workshop-examples/blob/main/linux/hardening.yml[https://github.com/ansible-tmm/RHEL-workshop-examples/blob/main/linux/hardening.yml,window=_blank]
...
image::exercise-2-6-workflows/job.png[launch_template,link=self,window=_blank]
