...
image::exercise-2-7-wrap/edit_host.png[edit host,link=self,window=_blank]
...
image::exercise-2-7-wrap/web_content_job_template.png[web_content_job_template,link=self,window=_blank]
