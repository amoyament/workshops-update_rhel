...
image::exercise-2-4-surveys/template_details.png[template details,link=self,window=_blank,width=60%]
...
image::exercise-2-4-surveys/survey_q1.png[Survey Q1,link=self,window=_blank,width=60%]
...
image::exercise-2-4-surveys/survey_q2.png[Survey Q2,link=self,window=_blank,width=60%]
...
Before the job starts, the survey will prompt for *First Line* and *Second Line*. Enter your text and click *Next*. The *Review* page shows the values—if all looks good, click *Finish* to start the job.

image::exercise-2-4-surveys/survey_launch.png[Survey Launch,link=self,window=_blank,width=60%]

image::exercise-2-4-surveys/survey_review.png[Survey Review,link=self,window=_blank,width=60%]
...
image::exercise-2-4-surveys/run_command.png[Run Command,link=self,window=_blank,width=60%]
