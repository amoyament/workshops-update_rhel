...
task path: /home/rhel/lab_inventory/collections/ansible_collections/webops/apache/roles/apache/tasks/main.yml:20
ok: [node01] => {
...
task path: /home/rhel/lab_inventory/collections/ansible_collections/webops/apache/roles/apache/tasks/main.yml:24
ok: [node01] => {
...
task path: /home/rhel/lab_inventory/collections/ansible_collections/webops/apache/roles/apache/tasks/main.yml:30
An exception occurred during task execution. To see the full traceback, use -vvv. The error was: If you are using a module and expect the file to exist on the remote, see the remote_src option
fatal: [node03]: FAILED! => {"changed": false, "msg": "Could not find or access 'files/missing_apache.conf'\nSearched in:\n\t/home/rhel/lab_inventory/roles/apache/files/files/missing_apache.conf\n\t/home/rhel/lab_inventory/roles/apache/files/missing_apache.conf\n\t/home/rhel/lab_inventory/roles/apache/tasks/files/files/missing_apache.conf\n\t/home/rhel/lab_inventory/roles/apache/tasks/files/missing_apache.conf\n\t/home/rhel/lab_inventory/files/files/missing_apache.conf\n\t/home/rhel/lab_inventory/files/missing_apache.conf on the Ansible Controller.\nIf you are using a module and expect the file to exist on the remote, see the remote_src option"}
An exception occurred during task execution. To see the full traceback, use -vvv. The error was: If you are using a module and expect the file to exist on the remote, see the remote_src option
fatal: [node01]: FAILED! => {"changed": false, "msg": "Could not find or access 'files/missing_apache.conf'\nSearched in:\n\t/home/rhel/lab_inventory/roles/apache/files/files/missing_apache.conf\n\t/home/rhel/lab_inventory/roles/apache/files/missing_apache.conf\n\t/home/rhel/lab_inventory/roles/apache/tasks/files/files/missing_apache.conf\n\t/home/rhel/lab_inventory/roles/apache/tasks/files/missing_apache.conf\n\t/home/rhel/lab_inventory/files/files/missing_apache.conf\n\t/home/rhel/lab_inventory/files/missing_apache.conf on the Ansible Controller.\nIf you are using a module and expect the file to exist on the remote, see the remote_src option"}
An exception occurred during task execution. To see the full traceback, use -vvv. The error was: If you are using a module and expect the file to exist on the remote, see the remote_src option
fatal: [node02]: FAILED! => {"changed": false, "msg": "Could not find or access 'files/missing_apache.conf'\nSearched in:\n\t/home/rhel/lab_inventory/roles/apache/files/files/missing_apache.conf\n\t/home/rhel/lab_inventory/roles/apache/files/missing_apache.conf\n\t/home/rhel/lab_inventory/roles/apache/tasks/files/files/missing_apache.conf\n\t/home/rhel/lab_inventory/roles/apache/tasks/files/missing_apache.conf\n\t/home/rhel/lab_inventory/files/files/missing_apache.conf\n\t/home/rhel/lab_inventory/files/missing_apache.conf on the Ansible Controller.\nIf you are using a module and expect the file to exist on the remote, see the remote_src option"}


TASK [apache : Handle Missing Configuration] ***********************************
task path: /home/rhel/lab_inventory/collections/ansible_collections/webops/apache/roles/apache/tasks/main.yml:39
ok: [node01] => {
...
PLAY RECAP *********************************************************************
node01                      : ok=7    changed=0    unreachable=0    failed=0    skipped=0    rescued=1    ignored=0
node02                      : ok=7    changed=0    unreachable=0    failed=0    skipped=0    rescued=1    ignored=0
node03                      : ok=7    changed=0    unreachable=0    failed=0    skipped=0    rescued=1    ignored=0
----
