...
[source,plaintext,role=copypaste]
----
...
PLAY RECAP *********************************************************************
control                  : ok=4    changed=1    unreachable=0    failed=0    skipped=4    rescued=0    ignored=0
node01                      : ok=8    changed=1    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
node02                      : ok=8    changed=1    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
node03                      : ok=8    changed=1    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
----

Verify the message of the day was deployed correctly:

[source,bash,role=copypaste]
----
ansible node01 -i hosts -m command -a "cat /etc/motd"
----
