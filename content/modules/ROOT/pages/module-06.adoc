...
[NOTE]
====
Your lab environment provides a pre-built EE image. The setup script has already pulled it for you.
====
...
image::exercise-1-6-navigator/navigator_images.png[ansible-navigator images TUI,link=self,window=_blank,width=60%]

You will see the `rhel_90_ee` image listed. Press the number shown next to it to open the EE detail menu.

image::exercise-1-6-navigator/navigator_ee_menu.png[EE detail menu,link=self,window=_blank,width=60%]

From the detail menu, select option *2* — *Ansible version and collections* — to inspect what is packaged inside the EE:

image::exercise-1-6-navigator/navigator_ee_collections.png[EE collections list,link=self,window=_blank,width=60%]
...
image::exercise-1-6-navigator/navigator_config.png[ansible-navigator configuration,link=self,window=_blank,width=60%]
...
image::exercise-1-6-navigator/navigator_run_output.png[ansible-navigator run output,link=self,window=_blank,width=60%]
...
image::exercise-1-6-navigator/curl_output.png[curl output,link=self,window=_blank,width=60%]
