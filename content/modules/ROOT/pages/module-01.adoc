...
image::exercise-1-1-setup/vscode-new-terminal.png[Opening a new terminal in VS Code,link=self,window=_blank,width=60%]
...
image::exercise-1-1-setup/system_setup_output.png[Playbook output,link=self,window=_blank,width=60%]
...
image::exercise-1-1-setup/system_checks_output.png[System checks playbook output,link=self,window=_blank,width=60%]
