...
image::exercise-1-1-setup/vscode-new-terminal.png[Opening a new terminal in VS Code]
...
image::exercise-1-1-setup/inventory_terminal.png[Inventory file contents]
