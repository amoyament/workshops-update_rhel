...
sudo -u rhel /usr/local/bin/ansible-galaxy collection install ansible.posix --force
sudo -u rhel /usr/local/bin/ansible-galaxy collection install community.general --force
